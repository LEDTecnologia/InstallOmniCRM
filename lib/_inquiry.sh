...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu OmniCRM LED Cloud que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador OmniCRM LED Cloud, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar OmniCRM LED Cloud\n"
  printf "   [1] Atualizar OmniCRM LED Cloud\n"
  printf "   [2] Deletar OmniCRM LED Cloud\n"
  printf "   [3] Bloquear OmniCRM LED Cloud\n"
  printf "   [4] Desbloquear OmniCRM LED Cloud\n"
  printf "   [5] Alter. dominio OmniCRM LED Cloud\n"
  printf "\n"
  read -p "> " option
